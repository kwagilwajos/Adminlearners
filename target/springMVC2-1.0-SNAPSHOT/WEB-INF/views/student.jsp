    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <ul class="nav nav-tabs" id="myTab">
                <li class="nav-item">
                    <a href="#add" class="nav-link active" data-bs-toggle="tab">Add Student</a>
                </li>
                <li class="nav-item">
                    <a href="#assign" class="nav-link" data-bs-toggle="tab">Assign Student to a Class</a>
                </li>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form:form modelAttribute="student" action="addStudent" cssClass="needs-validation" novalidate="true">

                                        <div >
                                            <label for="stname" class="form-label" >Name</label>
                                            <form:input type="text"  cssClass="form-control" id="stname" path="name" required="true" />
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="assign" method="post">
                                        <label for="sname" class="form-label">Student</label>
                        ...
                        <table id="datatable" class="display" style="width:100%">
                            ...
                            <c:forEach items="${students}" var="student">
                                <tr>
                                    ...
                                    <td><c:out value="${student.getStudentclass().getName()}"/></td>
                                    <td><a href="${pageContext.request.contextPath}/student/delete?id=${student.getId()}"> <i data-feather="trash-2"></i> </a></td>
                                </tr>
                            </c:forEach>
