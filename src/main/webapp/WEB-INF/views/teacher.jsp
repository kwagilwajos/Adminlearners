    ...
    <div class="row">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form:form modelAttribute="teacher" action="addTeacher" cssClass="needs-validation" novalidate="true">


                                <div >
                                    <label for="tname" class="form-label" >Name</label>
                                    <form:input type="text"  cssClass="form-control" id="tname" path="name" required="true" />
        ...
        <div class="col-md-12 ms-sm-auto col-lg-10 px-md-4">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Teachers Table</h6>
                        ...
                        <table id="datatable" class="display" style="width:100%">
                            ...
                            <c:forEach items="${teachers}" var="teacher">
                                <tr>
                                    ...
                                    <td><a href="${pageContext.request.contextPath}/teacher/delete?id=${teacher.getId()}"> <i data-feather="trash-2"></i> </a></td>
                                </tr>
                            </c:forEach>
